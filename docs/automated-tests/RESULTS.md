...
**136 cases** — 136 passed, 0 failed, 0 skipped. The generated inventory
[`20260915-154839/test-cases.md`](20260915-154839/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **129 → 136** since the previous run.
...
[`20260915-154839/perf.json`](20260915-154839/perf.json).
...
Current as of [`20260915-154839`](20260915-154839/) — **this run's measurement, not its diff.** Max CCN **15** across 678
