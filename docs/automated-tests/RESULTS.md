...
**185 cases** — 185 passed, 0 failed, 0 skipped. The generated inventory
[`20260916-094218/test-cases.md`](20260916-094218/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **136 → 185** since the previous run.
...
[`20260916-094218/perf.json`](20260916-094218/perf.json).
...
Current as of [`20260916-094218`](20260916-094218/) — **this run's measurement, not its diff.** Max CCN **15** across 824
